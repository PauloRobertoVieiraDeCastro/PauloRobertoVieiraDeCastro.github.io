...
function insRow(){
    ...
    entrada.style = "margin-top: 10px;margin-left: 20px";
    ...
    entrada2.style = "margin-top: 10px; margin-left: 20px;";
    ...
    entrada3.style = "margin-top: 10px; margin-left: 20px;";
    ...
    entrada4.style = "margin-top: 10px; margin-left: 20px";
    ...
    entrada5.style = "margin-top: 10px; margin-left: 20px";
...
function insRowP(){
    ...
    entrada2P.style = "margin-top: 10px; margin-left: 20px;";
    ...
    entrada3P.style = "margin-top: 10px; margin-left: 20px;";
    ...
    entrada4P.style = "margin-top: 10px; margin-left: 20px";
    ...
    entrada5P.style = "margin-top: 10px; margin-left: 20px";
